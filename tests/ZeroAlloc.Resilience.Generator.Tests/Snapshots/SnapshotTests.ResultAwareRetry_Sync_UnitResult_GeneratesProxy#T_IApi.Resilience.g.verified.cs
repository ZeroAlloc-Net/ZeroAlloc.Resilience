...
public sealed class ApiResiliencePolicies
{
    ...
    public global::ZeroAlloc.Resilience.TimeoutPolicy SendTimeout { get; set; } = new global::ZeroAlloc.Resilience.TimeoutPolicy(5000);
}
...
internal sealed class IApiResilienceProxy : global::T.IApi
{
    ...
    private readonly global::ZeroAlloc.Resilience.TimeoutPolicy _sendTimeout;
    ...
    public IApiResilienceProxy(global::T.IApi inner, ApiResiliencePolicies policies)
    {
        ...
        _sendTimeout = (policies.SendTimeout ?? throw new global::System.ArgumentException("ApiResiliencePolicies.SendTimeout is null.", nameof(policies)));
    }
    ...
    public global::ZeroAlloc.Results.Result<int, global::T.HttpError> Count()
    {
        if (!_circuitBreaker.CanExecute())
        {
            throw new global::ZeroAlloc.Resilience.ResilienceException(global::ZeroAlloc.Resilience.ResiliencePolicy.CircuitBreaker, "Circuit breaker is open.");
        ...
        global::System.Exception? __lastEx = null;
        global::ZeroAlloc.Results.Result<int, global::T.HttpError> __lastResult = default;
        bool __lastWasResult = false;
        for (int __attempt = 0; __attempt < _retry.MaxAttempts; __attempt++)
        {
            global::System.TimeSpan? __hint = null;
